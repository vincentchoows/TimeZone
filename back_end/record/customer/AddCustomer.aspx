<%@ Page Title="" Language="C#" MasterPageFile="~/back_end/backend.Master" AutoEventWireup="true" CodeBehind="AddCustomer.aspx.cs" Inherits="timezone.back_end.record.customer.AddCustomer" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2 class="record-title">Add New Customer </h2>
    ...
    <table class="content-area mb-4 customer-table" style="margin-left: 20em; width: 60%;">
        ...
        <tr>
            <td>Password</td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Password is required** <br/> " ControlToValidate="tbPassword" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
        ...
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ErrorMessage="Re-entering your password is required**<br/>" ControlToValidate="tbReenterPassword" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
        ...
        <tr>
            <td colspan="2" class="button-area">
                ...
                <asp:Button ID="cancelBtn" runat="server" Text="Cancel" CssClass="button" OnClick="cancelBtn_Click"  OnClientClick="return true;"/>
            </td>
        </tr>
